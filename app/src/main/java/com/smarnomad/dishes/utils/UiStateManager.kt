package com.smarnomad.dishes.utils
...
interface UiStateManager {
    ...
    enum class UiState {
        ...
        /**
         * UI has an error due to invalid credentials
         */
        INVALID_CREDENTIALS,

        /**
         * UI has an error due to server unauthorized request
         */
    ...
    fun initStateObserver(lifeCycle: LifecycleOwner, uiState: LiveData<UiState>) {
        uiState.observe(lifeCycle, Observer {
            when (it) {
                ...
                UiState.INVALID_CREDENTIALS -> onInvalidCredentials
                UiState.HTTP_ERROR_FORBIDDEN -> onError
                else -> {// Ignoring this
                }
            }
        })
    ...
    /**
     * Handle UI after Invalid Credentials
     */
    val onInvalidCredentials: () -> Unit
}
...
fun UiStateManager.UiState?.hasError(): Boolean {
    return this != null &&
            (this == UiStateManager.UiState.ERROR ||
                    ...
                    this == UiStateManager.UiState.INVALID_CREDENTIALS ||
                    this == UiStateManager.UiState.HTTP_ERROR_FORBIDDEN)
}
